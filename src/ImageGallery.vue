<template>
	<div class="slide">
		<div class="img-container" v-bind:style="{ 'backgroundImage': 'url(' + image01 + ')' }"></div>
	</div>
</template>

<script>
const images = require('./gallery.json').cesuImages
				  ...
				  */
				  function slideEnd(event) {
				    if (sliding == 2){
				      ...
				      pixelOffset = currentSlide * -$('.slide').width();
